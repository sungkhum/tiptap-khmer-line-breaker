...
const SAMPLE_TEXT = `ព្រះពុទ្ធសាសណាជាសាសនាចម្បងរបស់ប្រជាពនកម្ពុថា។ ប្រទេសកម្ពុជាមានទីតាំងស្ថិតនៅក្នុងតំបន់អាស៊ីអាគ្នេយ៍ ហើយមានប្រជាជនប្រមាណ១៧លាននាក់។ រាជធានីភ្នំពេញគឺជាទីក្រុងធំជាងគេនៅក្នុងប្រទេសកម្ពុជា។`
